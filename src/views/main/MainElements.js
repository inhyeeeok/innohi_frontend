    ...
    <div className="container" data-aos="fade-up">
      ...
      <div className="clients-slider swiper">
        <div className="swiper-wrapper align-items-center">
          ...
          <div className="swiper-slide"><a href='https://www.eventbrite.com/e/plug-and-play-silicon-valley-june-summit-tickets-312088333607?aff=ConnorDugan' target="_blank" rel="noopener noreferrer"><img src={require('../../assets/img/insight/contest/2022_pnp_summer_summit.jpg').default} className="img-fluid" style={{ width: "320px", height: "200px" }} alt=""></img></a></div>
        </div>
