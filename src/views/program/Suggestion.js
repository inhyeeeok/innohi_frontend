            ...
            <div className='row'>
              <div className='col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1' data-aos="fade-up" data-aos-delay="200">
                ...
                <h2 style={{ marginTop: '15px' }}>
                  ...
                  한진그룹과 협업하고 싶은 분야·주제를<br />자유롭게 제안해 주세요
                </h2>
        ...
        <section id="services" className="services section-bg">
          <div className="container" data-aos="fade-up">
            ...
            <div className="row">
              <div className="col-xl-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div className="icon-box" style={{ textAlign: 'center' }}>
                  ...
                  <h4 style={{ textAlign: 'center', fontSize: '22px', fontWeight: 'bold', marginTop: '10px' }}>다양한 산업분야<br />진출기반 마련</h4>
              ...
              <div className="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                <div className="icon-box" style={{ textAlign: 'center' }}>
                  ...
                  <h4 style={{ textAlign: 'center', fontSize: '22px', fontWeight: 'bold', marginTop: '10px' }}>사업 시너지 효과 창출<br /><br /></h4>
              ...
              <div className="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
                <div className="icon-box" style={{ textAlign: 'center' }}>
                  ...
                  <h4 style={{ textAlign: 'center', fontSize: '22px', fontWeight: 'bold', marginTop: '10px' }}>ICT기술 전문성 바탕의<br />PoC 검증 제공</h4>
            ...
            <div className='d-flex justify-content-center justify-content-start'>
              <a href='https://forms.gle/ouhCP4vATWWTcBN67' target="_blank" rel="noopener noreferrer" ><button className="btn-get-end">협업 제안하기</button ></a>
            </div>
          </div>
        </section>
      </>
